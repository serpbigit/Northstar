 ...
 */
function isServiceEnabled_(userId: any, handlerKey: any): any {
  const status: any = checkSubscriptionStatus_(userId); 

  const key: any = handlerKey.toLowerCase();
